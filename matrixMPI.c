...
int main(int argc, char *argv[])
{
	...
	MPI_Scatter(table1, size*rowsPerWorker, MPI_INT, t1Row, size*rowsPerWorker, MPI_INT, 0, MPI_COMM_WORLD);
	...
	//gather rows
	MPI_Gather(t3Row, size*rowsPerWorker, MPI_INT, table3, size*rowsPerWorker, MPI_INT, 0, MPI_COMM_WORLD);
